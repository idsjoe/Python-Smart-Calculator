# Main Python program
response = ['Welcome to smart calculator', 'My name is MONTY', 'Thanks for enjoying with me', 'Sorry, this is beyond my ability']
...
# Response to command
# Printing - "Thanks for enjoying with me" on exit
def end():
    print(response[2])
